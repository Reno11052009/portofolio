...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const pointers = [new PointerItem()];
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (!gl) {
        return { gl: null, ext: { formatRGBA: null, formatRG: null, formatR: null, halfFloatTexType: null, supportLinearFiltering: null } };
      }
    ...
    function getSupportedFormat(gl: any, internalFormat: number, format: number, type: any): { internalFormat: number; format: number } | null {
    ...
    function supportRenderTextureFormat(gl: any, internalFormat: number, format: number, type: any): boolean {
    ...
    function wakeUp() {
      ...
      if (!animationFrameId.current && isActive) {
    ...
    function updateFrame() {
      ...
      // Sleep if idle for more than 3 seconds
    ...
    function resizeCanvas() {
      ...
      // Cap maximum dimensions for performance
    ...
    function updatePointerDownData(pointer: any, id: number, clientX: number, clientY: number) {
      pointer.id = id;
      pointer.down = true;
      pointer.moved = false;
      pointer.texcoordX = clientX / canvas.clientWidth;
      pointer.texcoordY = 1.0 - clientY / canvas.clientHeight;
    ...
    function updatePointerMoveData(pointer: any, clientX: number, clientY: number, color: ColorRGB) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = clientX / canvas.clientWidth;
      pointer.texcoordY = 1.0 - clientY / canvas.clientHeight;
